...
public class SparkJobRegistry {
  ...
  /**
   * Get SparkJob corresponding to the given ID
   *
   * @param id of the job to retrieve
   * @return SparkJob
   */
  public SparkJob get(String id) {
    return jobs.getOrDefault(id, null);
  }

  /**
   * Remove SparkJob corresponding to the given ID
   *
